...
$wc.DownloadFile("http://ec2-54-213-106-231.us-west-2.compute.amazonaws.com:8081/nexus/content/repositories/releases/org/bar/%BUILD_NUMBER%/$ProjectPath.zip", "\\WIN-VQR8SOC8MKP\App\$ProjectPath.zip");
